...
module.exports = {
    ...
    callback: async (client, interaction) => {
        try {
            ...
            const expectedPasscode = "admin"; // Replace with your actual passcode
            ...
            setTimeout(async () => {
                await interaction
                    .editReply("✅ The bot has been rebooted!")
                    .then(() => {
                        client.destroy();
                        console.log(
                            `${client.user.tag} Restarted by ${interaction.user.tag} in ${interaction.guild.name}`,
                        );
                    });
